               ...
               <form action="<?php site_url('home/login'); ?>" method="post">
                           <div class="main">
                              ...
                              <div class="form-left-w3l">
                                 <input type="email" name="username" placeholder="<?php echo $this->lang->line("email"); ?>"/>
                                 <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                 <span style="color:white"><?php echo form_error('username'); ?></span>
                              </div>
                              <div class="form-right-w3ls ">
                                 <input type="password" name="password" placeholder="<?php echo $this->lang->line("password"); ?>"/>
                                 <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                                  <span style="color:white"><?php echo form_error('password'); ?></span>
                              </div>
                              <div class="btnn">
                                 <button type="submit"><?php echo $this->lang->line("login"); ?></button><br>
